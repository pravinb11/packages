...
namespace ufomap_manager
{
    ...
    public:
        ...
        // UFOMapManager(std::shared_ptr<rclcpp::Node> nh, std::shared_ptr<rclcpp::Node> nh_private);
        UFOMapManager(std::shared_ptr<rclcpp::Node> nh);
        ...
        // rclcpp::Publisher<::msg::>::SharedPtr info_pub_;
