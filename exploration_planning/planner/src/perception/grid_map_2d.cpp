...
namespace perception {
    ...
    GridMap2D::generateMapMarkers(std::vector<std::vector<Grid2D>> &grid_map, geometry_msgs::msg::Pose &current_pose) {

        visualization_msgs::msg::Marker free;
        visualization_msgs::msg::Marker occupied;
        visualization_msgs::msg::Marker empty;
        visualization_msgs::msg::Marker unknow;
        ...
        // empty.header.stamp = occupied.header.stamp = free.header.stamp = unknow.header.stamp = center_point.header.stamp = rclcpp::Time::now();
        empty.header.stamp = occupied.header.stamp = free.header.stamp = unknow.header.stamp = center_point.header.stamp = rclcpp::Clock().now();
        occupied.ns = "occupied";
        free.ns = "free";
        empty.ns = "empty";
        unknow.ns = "unknown";
        center_point.ns = "center";
        empty.action = occupied.action = free.action = unknow.action = center_point.action = visualization_msgs::msg::Marker::ADD;
        ...
        free.id = 0;
        free.type = visualization_msgs::msg::Marker::CUBE_LIST;

        occupied.id = 1;
        occupied.type = visualization_msgs::msg::Marker::CUBE_LIST;

        empty.id = 2;
        empty.type = visualization_msgs::msg::Marker::CUBE_LIST;

        unknow.id = 3;
        unknow.type = visualization_msgs::msg::Marker::CUBE_LIST;

        center_point.id = 4;
        center_point.type = visualization_msgs::msg::Marker::SPHERE_LIST;
        ...
        visualization_msgs::msg::MarkerArray grid_map_markers;
