...
namespace rapid_cover_planner {
    ...
    public:
        ...
        // RapidCoverPlanner(rclcpp::Node &nh, rclcpp::Node &nh_private,
        RapidCoverPlanner(const std::shared_ptr<rclcpp::Node> nh, const std::shared_ptr<rclcpp::Node> nh_private,
        ...
        void planning(const geometry_msgs::msg::Pose &current_pose, const utils::Point3D &current_directory, bool &is_successed);

        bool two_opt_solve_planning(const geometry_msgs::msg::Pose &current_pose, const utils::Point3D &current_directory);
