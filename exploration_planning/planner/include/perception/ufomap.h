...
namespace perception {
    ...
    public:
        ...
        // Ufomap(rclcpp::Node &nh, rclcpp::Node &nh_private);
        Ufomap(const std::shared_ptr<rclcpp::Node> nh, const std::shared_ptr<rclcpp::Node> nh_private);
        ...
        bool isInGeofencedVolume(const double &point_x, const double & point_y, const double & point_z) const;
        ...
        bool isInCollision(ufo::map::Point3 sensor_point, ufo::map::Point3 frontier_coord);
        ...
        rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr expand_cloud_pub_;
        ...
        // rclcpp::Publisher<geometry_msgs::msg::PolygonStamped>::SharedPtr ploygon_pub_;
        ...
        // TF2
        // tf2_ros::Buffer tf_buffer_;frontier
        std::shared_ptr<tf2_ros::Buffer> tf_buffer_;
        // tf2_ros::TransformListener tf_listener_;
        std::shared_ptr<tf2_ros::TransformListener> tf_listener_;
        rclcpp::Duration transform_timeout_; // "How long to wait for transform (s)",
        ...
        double pub_rate_;    // "How ofgetFrontiersten to publish map (hz)",
